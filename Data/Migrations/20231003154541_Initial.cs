        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plaintes_AspNetUsers_PersonneId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sos_AspNetUsers_PersonneId",
                        column: x => x.PersonneId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservtions_AspNetUsers_PersonneId",
                        column: x => x.PersonneId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonneVehicule", x => new { x.IdVehiculesVehiculeId, x.IdsId });
                    table.ForeignKey(
                        name: "FK_PersonneVehicule_AspNetUsers_IdsId",
                        column: x => x.IdsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonneVehicule_Vehicules_IdVehiculesVehiculeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonneVehicule_IdsId",
                table: "PersonneVehicule",
                column: "IdsId");

            migrationBuilder.CreateIndex(
                name: "IX_Plaintes_PersonneId",
                table: "Plaintes",
                column: "PersonneId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservtions_PersonneId",
                table: "Reservtions",
                column: "PersonneId");
