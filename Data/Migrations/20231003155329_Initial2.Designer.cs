...
namespace GogoDriverWeb.Data.Migrations
{
    ...
    [Migration("20231003155329_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonneVehicule", b =>
                {
                    ...
                    b.ToTable("PersonneVehicule");
                });

            modelBuilder.Entity("GogoDriverWeb.Models.Personne", b =>
                {
            ...
            modelBuilder.Entity("GogoDriverWeb.Models.Plainte", b =>
                {
                    b.HasOne("GogoDriverWeb.Models.Personne", "PersonneIdNavigation")
                        .WithMany("Plaintes")
            ...
            modelBuilder.Entity("PersonneVehicule", b =>
                {
                    ...
                    b.HasOne("GogoDriverWeb.Models.Personne", null)
                        .WithMany()
                        .HasForeignKey("IdsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
